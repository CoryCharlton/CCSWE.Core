...
namespace CCSWE.Threading.Tasks
{
    ...
    /// </summary>
    /// <remarks>Based on the article `Patterns for Asynchronous MVVM Applications: Data Binding` by Stephen Cleary (https://msdn.microsoft.com/magazine/dn605875)</remarks>
