...
namespace CCSWE
{
    ...
    {
        /// <summary>
        /// Creates a new <see cref="DateTime"/> with the time set to 23:59:59.
        /// </summary>
        /// <param name="dateTime">The source <see cref="DateTime"/>.</param>
        /// <returns>A <see cref="DateTime"/> with the time set to 23:59:59.</returns>
        ...
        /// <summary>
        /// Creates a new <see cref="DateTime"/> with the time set to 00:00:00.
        /// </summary>
        /// <param name="dateTime">The source <see cref="DateTime"/>.</param>
        /// <returns>A <see cref="DateTime"/> with the time set to 00:00:00.</returns>
